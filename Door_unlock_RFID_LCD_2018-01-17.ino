...
Button button = Button(8,PULLUP); // Pin for reading a second relay when opening from ESP8266
...
void setup() {
  ...
  lcd.begin();
  lcd.home();
  lcd.print("TEL. 070-7904214");
  lcd.setCursor(0, 1);
  lcd.print("Ringgatan 20");
  delay(5000);
  ...
  lcd.clear();
  lcd.print("SYSTEM REDO:");
  lcd.setCursor(0, 1);
  lcd.print("-SCANNA TAGG-");
...
void granted (int setDelay) {
  ...
  lcd.setCursor(3,1);
  lcd.print("XXXXX Kom in!");
  delay(4500);            // Hold green LED on for a second
  lcd.clear();
  lcd.print("VALKOMMEN!!");
  lcd.setCursor(0, 1);
  lcd.print("-SCANNA TAGG-");
